                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              "${"Invite your friend to sign up using your code and you’ll get".tr} ${Constant.currency}${double.parse(referralController.referralAmount.value.toString()).toStringAsFixed(int.parse(Constant.decimal.toString()))} ${"after successfully ride complete.".tr}",
